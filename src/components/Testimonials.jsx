const Testimonials = () => {
  ...
  const renderCard = (testimonial, index) => (
    <div
      key={index}
      className="bg-white border border-slate-200 hover:border-slate-300 rounded-xl p-4 shrink-0 w-[280px] sm:w-[320px] md:w-[350px]"
    >
      {/* Stars */}
  ...
  return (
    <>
      ...
      <section className="bg-[#FAFAFA] py-16 px-4 dark:bg-transparent dark:text-white">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-5xl font-medium text-neutral-900 mb-4 dark:text-white">
          ...
          <div className="space-y-6">
            ...
            {rows.map((row, rowIndex) => (
              <div key={rowIndex} className="relative overflow-hidden">
                ...
                {/* Fade edges */}
                <div className="absolute left-0 top-0 bottom-0 w-16 sm:w-28 bg-gradient-to-r from-[#FAFAFA] to-transparent z-10 pointer-events-none"></div>
                <div className="absolute right-0 top-0 bottom-0 w-16 sm:w-28 bg-gradient-to-l from-[#FAFAFA] to-transparent z-10 pointer-events-none"></div>

                <div className={`flex gap-4 sm:gap-6 ${row.className}`}>
